...
class ConsumptionFeedbackInterpretationTests(unittest.TestCase):
    ...
    def test_consumption_feedback_prompts_keep_json_inputs(self) -> None:
        ...
        self.assertEqual(set(pattern_prompt.input_variables), {"raw_json", "indicator_json"})
        self.assertEqual(set(problem_prompt.input_variables), {"raw_json", "indicator_json"})
        self.assertEqual(
            set(cause_prompt.input_variables),
            {"raw_json", "indicator_json", "pattern_text", "problem_text"},
        )
        self.assertEqual(
